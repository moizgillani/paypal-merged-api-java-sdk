...
public enum Server {
    ...
    static {
        ...
        DEFAULT_PAYMENT_METHOD_TOKENS.value = "default_Payment Method Tokens";

        valueMap.put("default", ENUM_DEFAULT);
        valueMap.put("default_Payment Method Tokens", DEFAULT_PAYMENT_METHOD_TOKENS);
    }
