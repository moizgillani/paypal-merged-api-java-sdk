...
import com.paypal.sandbox.apim.models.OAuthScopeOauth2PaymentMethodTokensEnum;
 ...
 */
public class Oauth2PaymentMethodTokensManager extends HeaderAuth implements Oauth2PaymentMethodTokensCredentials {
     ...
     */
    private Oauth2PaymentMethodTokensModel authModel;

    /**
     * Constructor.
     */
    public Oauth2PaymentMethodTokensManager(Oauth2PaymentMethodTokensModel authModel) {
    ...
    */
    ...
    /**
     * List of OAuthScopeOauth2PaymentMethodTokensEnum value for oAuthScopes.
     * @return oAuthScopes
     */
    public List<OAuthScopeOauth2PaymentMethodTokensEnum> getOAuthScopes() {
     ...
     * @param oAuthScopes List of OAuthScopeOauth2PaymentMethodTokensEnum value for credentials.
     * @return true if credentials matched.
     */
    public boolean equals(String oAuthClientId, String oAuthClientSecret, OAuthToken oAuthToken,
            List<OAuthScopeOauth2PaymentMethodTokensEnum> oAuthScopes) {
    ...
    /**
     * Converts this Oauth2PaymentMethodTokensManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Oauth2PaymentMethodTokensManager [" + "oAuthClientId=" + getOAuthClientId()
    ...
    public CompletableFuture<OAuthToken> fetchTokenAsync(
        ...
        return oAuthApi.requestTokenOauth2PaymentMethodTokensAsync(
    ...
    public OAuthToken fetchToken(Map<String, Object> additionalParameters)
        ...
        OAuthToken token = oAuthApi.requestTokenOauth2PaymentMethodTokens(
            getBasicAuthForClient(),
            stringJoin(getOAuthScopes(), " "),
            aparams);
    ...
    */
    ...
    public String getErrorMessage() {
        ...
        return "Oauth2PaymentMethodTokens - " + errorMessage;
     }
