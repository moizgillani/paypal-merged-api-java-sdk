 ...
 */
public class Oauth2PaymentMethodTokensModel {
    private String oAuthClientId;
    private String oAuthClientSecret;
    private OAuthToken oAuthToken;
    private List<OAuthScopeOauth2PaymentMethodTokensEnum> oAuthScopes;

    /**
     * A Constructor for Oauth2PaymentMethodTokensModel.
     */
    private Oauth2PaymentMethodTokensModel(String oAuthClientId, String oAuthClientSecret,
            OAuthToken oAuthToken, List<OAuthScopeOauth2PaymentMethodTokensEnum> oAuthScopes) {
    ...
    /**
     * Builds a new {@link Oauth2PaymentMethodTokensModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link Oauth2PaymentMethodTokensModel.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthScopes(List<OAuthScopeOauth2PaymentMethodTokensEnum> oAuthScopes) {
            this.oAuthScopes = oAuthScopes;
            return this;
        }

        /**
         * Builds the instance of Oauth2PaymentMethodTokensModel using the provided credentials.
         * @return The instance of Oauth2PaymentMethodTokensModel.
         */
        public Oauth2PaymentMethodTokensModel build() {
            return new Oauth2PaymentMethodTokensModel(oAuthClientId, oAuthClientSecret, oAuthToken,
                    oAuthScopes);
        }
    }
}