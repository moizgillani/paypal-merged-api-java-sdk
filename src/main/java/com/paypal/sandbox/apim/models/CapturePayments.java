...
/**
 * This is a model class for CapturePayments type.
 */
public class CapturePayments {
    ...
    /**
     * Converts this CapturePayments into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CapturePayments [" + "status=" + status + ", statusDetails=" + statusDetails
    ...
    /**
     * Builds a new {@link CapturePayments.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CapturePayments.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CapturePayments}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CapturePayments} object using the set fields.
         * @return {@link CapturePayments}
         */
        public CapturePayments build() {
            return new CapturePayments(status, statusDetails, id, amount, invoiceId, customId,
