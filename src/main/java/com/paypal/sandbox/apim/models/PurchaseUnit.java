...
public class PurchaseUnit {
     ...
     * @param  payee  Merchant value for payee.
     ...
     * Setter for Payee.
     * The merchant who receives payment for this transaction.
     * @param payee Value for Merchant
     */
    @JsonSetter("payee")
    public void setPayee(Merchant payee) {
        this.payee = payee;
    }
     ...
     * following ASCII characters: Alphanumeric characters, Dashes, Asterisks, Periods (.) Spaces
     * For Wallet payments marketplace integrations: The merchant descriptor in the Payment
     * Receiving Preferences must be the marketplace name. You can't use the remaining space to show
     * the customer service number. The remaining spaces can be a combination of seller name and
     * country. &lt;br/&gt;For unbranded payments (Direct Card) marketplace integrations, use a
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder payee(Merchant payee) {
            this.payee = payee;
            return this;
        }
