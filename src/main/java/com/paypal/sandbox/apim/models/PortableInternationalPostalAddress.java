...
public class PortableInternationalPostalAddress {
     ...
     * Value is: The postal sorting code for Guernsey and many French territories, such as French
     * Guiana. The fine-grained administrative levels in China.
     * @return Returns the String
     */
     ...
     * is: Brazil. Suburb, bairro, or neighborhood. India. Sub-locality or district. Street name
     * information is not always available but a sub-locality or district can be a very small area.
     * @return Returns the String
     */
