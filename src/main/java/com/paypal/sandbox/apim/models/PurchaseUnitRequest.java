...
public class PurchaseUnitRequest {
     ...
     * in the statement. &lt;br&gt;For example, if: The PayPal prefix toggle is PAYPAL*. The merchant
     * descriptor in the profile is Janes Gift. The soft descriptor is 800-123-1234. Then, the
