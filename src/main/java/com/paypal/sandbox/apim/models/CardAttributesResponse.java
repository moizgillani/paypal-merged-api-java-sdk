...
public class CardAttributesResponse {
     ...
     * @param  vault  VaultStatusEnum value for vault.
     */
    public CardAttributesResponse(
            VaultStatusEnum vault) {
        this.vault = vault;
    }
    ...
    public VaultStatusEnum getVault() {
        return vault;
    }
     ...
     * Setter for Vault.
     * The vault status.
     * @param vault Value for VaultStatusEnum
     */
    @JsonSetter("vault")
    public void setVault(VaultStatusEnum vault) {
        this.vault = vault;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder vault(VaultStatusEnum vault) {
            this.vault = vault;
            return this;
        }
