...
/**
 * ReqParamCustInitPayDescEnum to be used.
 */
public enum ReqParamCustInitPayDescEnum {
    ...
    private static TreeMap<String, ReqParamCustInitPayDescEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ReqParamCustInitPayDescEnum constructFromString(String toConvert) throws IOException {
        ReqParamCustInitPayDescEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ReqParamCustInitPayDescEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ReqParamCustInitPayDescEnum values to list of string values.
     * @param toConvert The list of ReqParamCustInitPayDescEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ReqParamCustInitPayDescEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ReqParamCustInitPayDescEnum enumValue : toConvert) {
