...
/**
 * This is a model class for M422ErrorPayments type.
 */
public class M422ErrorPayments {
    ...
    /**
     * Converts this M422ErrorPayments into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M422ErrorPayments [" + "name=" + name + ", message=" + message + ", issues="
                + issues + ", debugId=" + debugId + ", informationLink=" + informationLink + "]";
    }

    /**
     * Builds a new {@link M422ErrorPayments.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M422ErrorPayments.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M422ErrorPayments}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M422ErrorPayments} object using the set fields.
         * @return {@link M422ErrorPayments}
         */
        public M422ErrorPayments build() {
            return new M422ErrorPayments(name, message, issues, debugId, informationLink);
        }
    }
}
