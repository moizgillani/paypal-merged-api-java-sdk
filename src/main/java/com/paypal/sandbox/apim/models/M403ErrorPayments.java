...
/**
 * This is a model class for M403ErrorPayments type.
 */
public class M403ErrorPayments {
    ...
    /**
     * Converts this M403ErrorPayments into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "M403ErrorPayments [" + "name=" + name + ", message=" + message + ", issues="
                + issues + ", debugId=" + debugId + ", informationLink=" + informationLink + "]";
    }

    /**
     * Builds a new {@link M403ErrorPayments.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link M403ErrorPayments.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link M403ErrorPayments}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link M403ErrorPayments} object using the set fields.
         * @return {@link M403ErrorPayments}
         */
        public M403ErrorPayments build() {
            return new M403ErrorPayments(name, message, issues, debugId, informationLink);
        }
    }
}
