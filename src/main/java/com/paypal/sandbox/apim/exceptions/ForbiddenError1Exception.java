...
/**
 * This is a model class for ForbiddenError1Exception type.
 */
public class ForbiddenError1Exception extends ApiException {
    private static final long serialVersionUID = 5897743651496L;
     ...
     */
    public ForbiddenError1Exception(String reason, Context context) {
