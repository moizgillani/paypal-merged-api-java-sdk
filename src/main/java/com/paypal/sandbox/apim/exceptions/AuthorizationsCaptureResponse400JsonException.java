...
import com.paypal.sandbox.apim.models.ErrorDetails3Payments;
...
public class AuthorizationsCaptureResponse400JsonException extends ApiException {
    private static final long serialVersionUID = -4149772551184583295L;
    private BadRequestNameEnum name;
    private BadRequestMessageEnum message;
    private List<ErrorDetails3Payments> issues;
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails3Payments
     */
    @JsonGetter("issues")
    public List<ErrorDetails3Payments> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails3Payments
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails3Payments> issues) {
        this.issues = issues;
    }
