...
import com.paypal.sandbox.apim.models.ErrorDetails7Payments;
...
public class AuthorizationsReauthorizeResponse400JsonException extends ApiException {
    private static final long serialVersionUID = -6661482969404661455L;
    private BadRequestNameEnum name;
    private BadRequestMessageEnum message;
    private List<ErrorDetails7Payments> issues;
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails7Payments
     */
    @JsonGetter("issues")
    public List<ErrorDetails7Payments> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails7Payments
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails7Payments> issues) {
        this.issues = issues;
    }
