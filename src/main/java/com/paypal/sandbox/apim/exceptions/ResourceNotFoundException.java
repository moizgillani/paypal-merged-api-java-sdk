...
import com.paypal.sandbox.apim.models.ErrorDetails4;
...
/**
 * This is a model class for ResourceNotFoundException type.
 */
public class ResourceNotFoundException extends ApiException {
    private static final long serialVersionUID = 5783187421278256717L;
    private ResourceNotFoundNameEnum name;
    private ResourceNotFoundMessageEnum message;
    private List<ErrorDetails4> issues;
     ...
     */
    public ResourceNotFoundException(String reason, Context context) {
    ...
    /**
     * Getter for Issues.
     * @return Returns the List of ErrorDetails4
     */
    @JsonGetter("issues")
    public List<ErrorDetails4> getIssues() {
        return this.issues;
    }

    /**
     * Setter for Issues.
     * @param issues Value for List of ErrorDetails4
     */
    @JsonSetter("issues")
    private void setIssues(List<ErrorDetails4> issues) {
        this.issues = issues;
    }
