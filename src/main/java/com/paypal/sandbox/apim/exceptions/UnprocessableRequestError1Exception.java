...
/**
 * This is a model class for UnprocessableRequestError1Exception type.
 */
public class UnprocessableRequestError1Exception extends ApiException {
    private static final long serialVersionUID = -5970615228680678732L;
     ...
     */
    public UnprocessableRequestError1Exception(String reason, Context context) {
